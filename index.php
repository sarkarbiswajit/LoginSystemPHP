...
$sql = "insert into stud values('$email','$pass')";
...
<h1>Please enter your email and password</h1>
    <form action="/mydata/index.php" method="post">
    ...
    <div class="form-group">
        ...
        <input type="password" class="form-control" id="pass" name="pass" aria-describedby="pass" required>
